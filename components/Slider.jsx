      ...
      >
        <SwiperSlide>
          ...
          >
            ...
            <h1 className="uppercase z-10 text-[6.5rem] lg:text-[14rem] font-[Commador]">
              welcome
            </h1>
            <h2 className="uppercase z-10 text-[1.8rem] tracking-[0.5rem] lg:text-[3rem] font-[Commador]  lg:tracking-[1.3rem]">
              to viva jalisco
            </h2>
